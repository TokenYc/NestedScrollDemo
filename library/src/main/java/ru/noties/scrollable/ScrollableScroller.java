...
public class ScrollableScroller  {
    ...
    private static float DECELERATION_RATE = 0;
        private static final float INFLEXION = 0.23f; // Tension lines cross at (INFLEXION, 1)
    ...
    /*private*/ int getSplineFlingDuration(float velocity) {
        ...
        return (int) (600.0 * Math.exp(l / decelMinusOne));
    }
